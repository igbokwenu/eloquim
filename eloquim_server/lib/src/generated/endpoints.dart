...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'persona': _i6.PersonaEndpoint()
        ..initialize(
          server,
          'persona',
          null,
        ),
      'recommendation': _i7.RecommendationEndpoint()
        ..initialize(
          server,
          'recommendation',
          null,
      ...
      methodConnectors: {
        ...
        'getMessages': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['chat'] as _i4.ChatEndpoint).getMessages(
                session,
        ...
        'markAsRead': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['chat'] as _i4.ChatEndpoint).markAsRead(
                session,
                params['conversationId'],
                params['messageId'],
              ),
        ...
        'streamChat': _i1.MethodStreamConnector(
          ...
          call:
              ...
              ) => (endpoints['chat'] as _i4.ChatEndpoint).streamChat(
                session,
                params['conversationId'],
              ),
        ),
        ...
        'getOfficialPersonas': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['persona'] as _i6.PersonaEndpoint)
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['persona'] as _i6.PersonaEndpoint).getPersona(
                    session,
                    params['personaId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['persona'] as _i6.PersonaEndpoint).assignPersona(
                    session,
                    params['personaId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['recommendation'] as _i7.RecommendationEndpoint)
                      .getRecommendations(
                        session,
                        params['conversationId'],
                        params['partialText'],
