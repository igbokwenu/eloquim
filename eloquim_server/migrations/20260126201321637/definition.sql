...
--
-- Class EmojiMapping as table emoji_mappings
--
...
--
-- Class Persona as table personas
--
...
--
-- Foreign relations for "emoji_mappings" table
--
...
--
-- Foreign relations for "personas" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('eloquim', '20260126201321637', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260126201321637', "timestamp" = now();
